...
export default function AutoResize() {
  ...
  return (
    <>
      ...
      <div
        ref={targ}
        className="w-full bg-gradient-to-l from-slate-900 to-green-900 mb-4 flex flex-col p-2 gap-4 border border-green-200 text-green-200 rounded text-center overflow-hidden cursor-default"
      >
      ...
      <div
        ref={targRight}
        className="w-full bg-gradient-to-r from-slate-900 to-blue-900 mb-4 flex flex-col p-2 gap-4 border border-blue-200 text-blue-200 rounded text-center overflow-hidden cursor-default"
      >
        <p>&#10132;</p>
      </div>
      <button
      ...
      <div
        ref={targUp}
        className="w-full bg-gradient-to-t from-slate-900 to-indigo-900 mb-4 flex flex-col p-2 gap-4 border border-indigo-200 text-indigo-200 rounded text-center overflow-hidden cursor-default"
      >
      ...
      <div
        ref={targDown}
        className="w-full bg-gradient-to-b from-slate-900 to-violet-900 mb-4 flex flex-col p-2 gap-4 border border-indigo-200 text-indigo-200 rounded text-center overflow-hidden cursor-default"
      >
      ...
      {/* </div> */}
      <h2 className="w-[90%] md:w-1/2 mx-auto pb-4 text-slate-300 text-xl underline text-center">
        So how does it work?{" "}
      </h2>
      <p className="w-[90%] md:w-1/2 mx-auto pb-4 text-slate-300 text-center">
      ...
      <p className="w-[90%] md:w-1/2 mx-auto py-4 text-slate-300 text-center">
        By returning the toggle function, useAutoResize gives you the freedom to
        delegate control of your targets resize animation to any element in your
        project without worrying about colocating state or drilling props -
